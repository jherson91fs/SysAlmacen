        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/jherson91fs/SysAlmacen.git'
                }
            }
        }
        stage('Build') {
